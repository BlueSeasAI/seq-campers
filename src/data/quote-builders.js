...
export const quoteBuilders = [
  ...
  // -------------------------------------------------------------------------
  // KIMBERLEY KRUISER - 3 models on one page: S Class Classic, S3 30th
  // Anniversary, and the 7.3m T Class (T3). Rebuilt from Maud's kruiser.html
  // (source of truth for per-variant pricing + included/N-A rules). Replaces
  ...
  // -------------------------------------------------------------------------
  {
    ...
    delivery: 3500,
    variants: [
      { id: 'classic', name: 'Kruiser S Classic', basePrice: 135800, included: [
      ...
      { id: 's3', name: 'Kruiser S3 30th Anniversary', basePrice: 172100, included: [
          "Everything in Classic, plus:",
      ...
      { id: 't3', name: 'Kruiser T3 - Fully Loaded', basePrice: 220100, included: [
    ...
    categories: [
      {
        ...
        title: "Suspension & Chassis",
        options: [
          { id: "drawbar", label: "Revolutionary Turning Drawbar Extension", priceByVariant: { classic: 500, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "airsusp", label: "Air Suspension PLUS – compressor, tank, electronic fill & remote", priceByVariant: { classic: 2255, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "airkit", label: "Air Kit & Hoses (tyre gauge, blow gun, coiled hose)", priceByVariant: { classic: 285, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "remote-shocks", label: "2.5\" Remote Reservoir Mono-tube Shocks with Damping Adjustor", priceByVariant: { classic: 1060, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "stonedefl", label: "Custom Stone Deflector (vehicle-to-van stone barrier)", priceByVariant: { classic: 820, s3: 820, t3: 820 } },
          { id: "fold-steps", label: "Internal Fold-Down Entry Steps with Handrail (4 steps, travel inside)", priceByVariant: { classic: 990, s3: 990, t3: 990 } },
          { id: "do45", label: "VC DO45 4500kg Off-Road Hitch (upgrade from McHitch)", priceByVariant: { classic: null, s3: null, t3: 0 }, naNote: "T3 Class only" },
          { id: "airbag-monitor", label: "Airbag Monitor Kit in Vehicle", priceByVariant: { classic: null, s3: null, t3: 285 }, naNote: "T3 Class only" },
          { id: "reverse-cam-ready", label: "SMART Wireless WiFi Reverse Camera + side sensors + dashcam", priceByVariant: { classic: 1295, s3: 1295, t3: 1295 } },
        ],
      },
      {
        id: "wheels",
        title: "Wheels",
        options: [
          { id: "alloy17", label: "KK Alloy Off-Road Wheels 17\" AT Tyres", priceByVariant: { classic: 1250, s3: 0, t3: 0 } },
          { id: "alloy18", label: "Upgrade to 18\" Alloys & Rims", priceByVariant: { classic: 1580, s3: 1580, t3: 550 } },
        ],
      },
      {
        id: "water",
        title: "Water",
        options: [
          { id: "extra-tank", label: "50L Extra Water Tank (under shower)", priceByVariant: { classic: 790, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "grey-tank", label: "60L Grey Water Tank (sink collection)", priceByVariant: { classic: 1060, s3: 0, t3: null }, naNote: "Not on T3 Class" },
        ],
      },
      {
        id: "awnings",
        ...
        options: [
          { id: "elec-awning", label: "Electric Open & Close Awning", priceByVariant: { classic: 1050, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "bedouin", label: "Bedouin Extendable Awning", priceByVariant: { classic: 1310, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "full-walls", label: "Full Canvas Mesh Wall Set (fully enclosed, anti-flap kit)", priceByVariant: { classic: 4170, s3: 4170, t3: 4300 } },
          { id: "draft-skirt", label: "Draft Skirt", priceByVariant: { classic: 740, s3: 740, t3: 790 } },
          { id: "kwik-sun", label: "Kwik Sun Awning (sun reduction) + Driver Side Sail Track included", priceByVariant: { classic: 1390, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "bedroom-curtain", label: "Bedroom Curtain (privacy divider)", priceByVariant: { classic: null, s3: null, t3: 880 }, naNote: "T3 Class only" },
        ],
      },
      {
        id: "comfort",
        title: "Comfort & Heating",
        options: [
          { id: "ac", label: "Harrier Rooftop Reverse Cycle A/C (3.1kW cooling / 2.8kW heating)", priceByVariant: { classic: 3910, s3: 0, t3: 0 } },
          { id: "midge", label: "Midge Screen Magnetic Doors", priceByVariant: { classic: 380, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "vbreathe", label: "Vbreathe Ionic Air Purifier & Sanitiser", priceByVariant: { classic: null, s3: null, t3: 840 }, naNote: "T3 Class only" },
          { id: "winterise", label: "Winterise All Plumbing & Water Tanks", priceByVariant: { classic: null, s3: null, t3: 2500 }, naNote: "T3 Class only" },
          { id: "fan1", label: "12V Fan with Timer (1st)", priceByVariant: { classic: 275, s3: 275, t3: null }, naNote: "Not on T3 Class" },
          { id: "fan2", label: "12V Fan with Timer (2nd)", priceByVariant: { classic: 275, s3: 275, t3: null }, requires: ["fan1"], depNote: "Add the first fan", naNote: "Not on T3 Class" },
        ],
      },
      {
        id: "ensuite",
        title: "Ensuite",
        options: [
          { id: "washing-machine", label: "Top-Loading Washing Machine (easy-access slide-out tray)", priceByVariant: { classic: 790, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "freezer", label: "40L Isotherm Upright Freezer or Fridge (in ensuite)", priceByVariant: { classic: 1920, s3: 1920, t3: 1920 } },
        ],
      },
      {
        id: "kitchen",
        title: "Kitchen",
        options: [
          { id: "dual-induction", label: "Smart RV Dual Plate Induction Cooktop (built-in)", priceByVariant: { classic: 1100, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "microwave", label: "Microwave Oven (inside)", priceByVariant: { classic: 420, s3: 420, t3: null }, naNote: "Not on T3 Class" },
          { id: "hooded-bbq", label: "Galley Kitchen – Marine Hooded Gas BBQ (replaces 2-burner)", note: "Choose one outside BBQ.", priceByVariant: { classic: 390, s3: 390, t3: 0 }, blockedBy: ["weber"] },
          { id: "weber", label: "Galley Kitchen – Weber® BabyQ™ BBQ (replaces 2-burner)", note: "Choose this instead of the hooded BBQ.", priceByVariant: { classic: 390, s3: 390, t3: null }, blockedBy: ["hooded-bbq"], naNote: "Not on T3 Class" },
          { id: "wok-outside", label: "Large Single WOK Burner with wind deflector ring (outside)", priceByVariant: { classic: 530, s3: 530, t3: 530 } },
          { id: "boot-fridge", label: "80L Fridge/Freezer in Tunnel Boot on Slide", priceByVariant: { classic: 3300, s3: 3300, t3: 3300 } },
          { id: "65l-freezer", label: "Option 2: 130L Fridge + 65L Drawer Freezer (driver side)", priceByVariant: { classic: null, s3: null, t3: 1700 }, naNote: "T3 Class only" },
        ],
      },
      {
        id: "power",
        title: "Power & Solar",
        options: [
          { id: "5000wh", label: "Upgrade to 5000Wh SMART 48V Battery (Classic)", priceByVariant: { classic: 4030, s3: 0, t3: 0 } },
          { id: "extra-5000wh", label: "Extra 5000Wh SMART 48V Battery (adds to existing)", priceByVariant: { classic: 7100, s3: 7100, t3: 7100 }, requires: ["5000wh"], depNote: "Add 5000Wh battery first" },
          { id: "solar400", label: "Upgrade to 400W Merlin NASA Solar", priceByVariant: { classic: 650, s3: null, t3: null }, blockedBy: ["solar500", "solar900"], naNote: "Classic only" },
          { id: "solar500", label: "Upgrade to 500W Merlin NASA Solar", priceByVariant: { classic: 1420, s3: 0, t3: null }, blockedBy: ["solar400", "solar900"], naNote: "Not on T3 Class" },
          { id: "witi", label: "WiTi Anti-theft, GPS Tracking + Wireless Trailer Plug", priceByVariant: { classic: 1650, s3: 1650, t3: 1650 } },
          { id: "portable-solar", label: "Portable 170W Merlin USA Solar (10m lead)", priceByVariant: { classic: 1710, s3: 1710, t3: 1710 } },
          { id: "smart-touch", label: "Smart Touch PLUS Monitor (water, fridge, shock temps)", priceByVariant: { classic: 0, s3: 0, t3: 0 } },
          { id: "solar900", label: "Upgrade to 900W Merlin NASA Solar (no A/C with this option)", note: "Selecting this removes the rooftop A/C (a $3,910 credit applies on your quote).", priceByVariant: { classic: null, s3: null, t3: 970 }, blockedBy: ["solar400", "solar500"], naNote: "T3 Class only" },
        ],
      },
      {
        id: "storage",
        title: "Storage",
        options: [
          { id: "unipod", label: "UniPod Fibreglass Multibox Upgrade (2x Jerry Cans, 9kg gas, generator)", priceByVariant: { classic: 1120, s3: 1120, t3: null }, naNote: "Not on T3 Class" },
          { id: "side-stor-ps", label: "Side Storage Pak – Rear Passenger Side", priceByVariant: { classic: 580, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "side-stor-ds", label: "Side Storage Pak – Rear Driver Side", priceByVariant: { classic: 580, s3: 580, t3: 580 } },
          { id: "upright-storage", label: "Upright Storage Cupboard in Ensuite (in lieu of washing machine)", priceByVariant: { classic: null, s3: null, t3: 790 }, naNote: "T3 Class only" },
        ],
      },
      {
        id: "multimedia",
        title: "Multimedia & Connectivity",
        options: [
          { id: "premium-stereo", label: "Premium All-in-One Panel Stereo (Bluetooth, AM/FM, USB, AUX)", priceByVariant: { classic: 570, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "tv-antenna", label: "Compact TV Antenna – King Aerial on roof with booster", priceByVariant: { classic: 680, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "tv", label: "28\" Smart LED TV + Bracket + Swivel Knuckle + Padded Bag", priceByVariant: { classic: 1630, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "4g", label: "4G Digital Communication System (modem + high-gain antenna)", priceByVariant: { classic: 1150, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "5g", label: "5G Shark Fin High-Gain Antenna Upgrade", priceByVariant: { classic: 780, s3: 780, t3: null }, naNote: "Not on T3 Class" },
          { id: "celfi", label: "Celfi Go Telstra Repeater Station (outback mobile & internet)", priceByVariant: { classic: null, s3: null, t3: 2040 }, naNote: "T3 Class only" },
        ],
      },
      {
        id: "seating",
        title: "Seating & Bed",
        options: [
          { id: "latin-seat", label: "Latin Chaise Lounge Seat Upgrade (easy underseat storage)", priceByVariant: { classic: 790, s3: 0, t3: null }, naNote: "Not on T3 Class" },
          { id: "innerspring", label: "Upgrade to Innerspring Mattress – Superb Luxury (Classic only)", priceByVariant: { classic: 320, s3: 0, t3: 0 } },
          { id: "airsoft", label: "Queen AIRSOFT™ Mattress – memory foam + aired core (Classic)", priceByVariant: { classic: 1575, s3: null, t3: 1255 }, naNote: "Not on S3 30th" },
          { id: "airsoft-s3", label: "Queen AIRSOFT™ Mattress – memory foam + aired core (S3)", priceByVariant: { classic: null, s3: 1255, t3: null }, naNote: "S3 30th only" },
          { id: "leather", label: "Real Leather Seating (27 colour options, 100% Australian hides)", priceByVariant: { classic: 970, s3: 0, t3: null }, naNote: "Not on T3 Class" },
        ],
      },
    ],
  },
