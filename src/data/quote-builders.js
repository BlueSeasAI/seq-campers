...
export const quoteBuilders = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    variants: [
      ...
      {
        id: 'sl-intrepid',
        name: 'Rover 02 Super Lite - Intrepid',
        basePrice: 59990,
        flags: { ultra: false, lite: true },
        included: [
          'Aluminium chassis, 7-leaf all-terrain leaf springs',
          '10" electric drum brakes, 17" alloy wheels, 235/65R17 A/T tyres',
          'ATM 1,600kg, Tare from 1,160kg',
          '12V Direct system, 40A DC-DC, 120Ah lithium, 100W solar',
          'Joolca instant gas shower (external)',
        ],
      },
      {
        id: 'sl-ultra',
        name: 'Rover 02 Super Lite - Ultra',
        basePrice: 74990,
        flags: { ultra: true, lite: true },
        included: [
          'Everything in Super Lite Intrepid, plus:',
          'REDARC RedVision system, 300Ah lithium, 400W solar',
          'Reverse-cycle A/C, diesel hot water shower, 240V system',
          'Stone guard',
          'ATM 1,600kg, Tare from 1,250kg',
        ],
      },
    ],
    categories: [
      {
        ...
        options: [
          { id: 'redvision', label: 'REDARC RedVision Power System', note: 'Smartphone app control, nationwide RedNetwork support.', priceByVariant: { 'xt-intrepid': 3700, 'xt-ultra': 0, 'sl-intrepid': 3700, 'sl-ultra': 0 } },
          { id: 'rooftop-ac', label: '240V Reverse-Cycle Air Conditioning', note: 'Roof-mounted. Can run off-grid with a 2000W inverter.', requires: ['redvision'], depNote: 'Add RedVision', priceByVariant: { 'xt-intrepid': 3800, 'xt-ultra': 0, 'sl-intrepid': 3800, 'sl-ultra': 0 } },
          { id: 'battery-300ah', label: 'Upgrade to 300Ah Lithium Battery', note: 'More off-grid power capacity.', priceByVariant: { 'xt-intrepid': 1900, 'xt-ultra': 0, 'sl-intrepid': 1900, 'sl-ultra': 0 } },
          ...
          { id: 'shore-power', label: '240V Shore Power System', note: '15A inlet, kitchen and bedroom double power outlets.', priceByVariant: { 'xt-intrepid': 1200, 'xt-ultra': 0, 'sl-intrepid': 1200, 'sl-ultra': 0 } },
          { id: 'inverter-12v', label: '2000W 12V Inverter', note: 'Intrepid models. Run appliances off battery.', blockedBy: ['redvision'], blockedNote: 'Use REDARC', naNote: 'Ultra: REDARC', priceByVariant: { 'xt-intrepid': 1600, 'xt-ultra': null, 'sl-intrepid': 1600, 'sl-ultra': null } },
          ...
          { id: 'portable-solar', label: 'Portable 220W Solar Panels', note: 'Top up batteries on the move.', priceByVariant: { 'xt-intrepid': 950, 'xt-ultra': 0, 'sl-intrepid': 950, 'sl-ultra': 0 } },
          { id: 'diesel-shower', label: 'Diesel Hot Water Heater + Shower Kit', note: 'Darche drop-down shower tent, hot and cold mixer, shower rose.', priceByVariant: { 'xt-intrepid': 4900, 'xt-ultra': 0, 'sl-intrepid': 4900, 'sl-ultra': 0 } },
          { id: 'diesel-heater', label: 'Diesel Air Heater', note: 'Fitted to diesel water heater, includes cabinetry change.', price: 3150 },
          { id: 'kitchen-wall-roof', label: 'Kitchen Wall & Roof Kit', note: 'Tailgate cover plus two polyester walls for weather protection.', priceByVariant: { 'xt-intrepid': 900, 'xt-ultra': 0, 'sl-intrepid': 900, 'sl-ultra': 0 } },
          { id: 'stone-guard', label: 'Stone Guard', note: 'Required with the diesel heater option to mount the diesel tank.', priceByVariant: { 'xt-intrepid': 900, 'xt-ultra': 0, 'sl-intrepid': 900, 'sl-ultra': 0 } },
        ],
      },
      {
        id: 'awnings',
      ...
      },
      {
        ...
        options: [
          { id: 'airbag-suspension', label: 'Airbag Suspension Upgrade', note: 'Manual height adjust, compressor and remote.', naNote: 'Not on Super Lite', priceByVariant: { 'xt-intrepid': 4990, 'xt-ultra': 4990, 'sl-intrepid': null, 'sl-ultra': null } },
